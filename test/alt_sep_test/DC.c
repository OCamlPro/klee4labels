...
{
  int __retres;
  cov_label(Climb_Inhibit == 1,1,"DC");
  cov_label(! (Climb_Inhibit == 1),2,"DC");
  if (Climb_Inhibit == 1) {
...
_Bool Non_Crossing_Biased_Climb(void)
{
  ...
  cov_label(upward_preferred,3,"DC");
  cov_label(! upward_preferred,4,"DC");
  if (upward_preferred) {
    int tmp_3;
    _Bool tmp_0;
    tmp_0 = Own_Below_Threat();
    cov_label(tmp_0,5,"DC");
    cov_label(! tmp_0,6,"DC");
    if (tmp_0) {
      _Bool tmp_1;
      tmp_1 = Own_Below_Threat();
      cov_label(tmp_1,7,"DC");
      cov_label(! tmp_1,8,"DC");
      if (tmp_1) {
        int tmp_2;
        tmp_2 = ALIM();
        ;
        cov_label(Down_Separation >= tmp_2,9,"DC");
        cov_label(! (Down_Separation >= tmp_2),10,"DC");
    ...
    cov_label(tmp_4,11,"DC");
    cov_label(! tmp_4,12,"DC");
    if (tmp_4) {
      cov_label(Cur_Vertical_Sep >= 300,13,"DC");
      cov_label(! (Cur_Vertical_Sep >= 300),14,"DC");
      if (Cur_Vertical_Sep >= 300) {
        int tmp_5;
        tmp_5 = ALIM();
        ;
        cov_label(Up_Separation >= tmp_5,15,"DC");
        cov_label(! (Up_Separation >= tmp_5),16,"DC");
...
_Bool Non_Crossing_Biased_Descend(void)
{
  ...
  tmp = Inhibit_Biased_Climb();
  upward_preferred = tmp > Down_Separation;
  cov_label(upward_preferred,17,"DC");
  cov_label(! upward_preferred,18,"DC");
  if (upward_preferred) {
    int tmp_2;
    _Bool tmp_0;
    tmp_0 = Own_Below_Threat();
    cov_label(tmp_0,19,"DC");
    cov_label(! tmp_0,20,"DC");
    if (tmp_0) {
      cov_label(Cur_Vertical_Sep >= 300,21,"DC");
      cov_label(! (Cur_Vertical_Sep >= 300),22,"DC");
      if (Cur_Vertical_Sep >= 300) {
        int tmp_1;
        tmp_1 = ALIM();
        ;
        cov_label(Down_Separation >= tmp_1,23,"DC");
        cov_label(! (Down_Separation >= tmp_1),24,"DC");
    ...
    cov_label(tmp_3,25,"DC");
    cov_label(! tmp_3,26,"DC");
    if (tmp_3) {
      _Bool tmp_4;
      tmp_4 = Own_Above_Threat();
      cov_label(tmp_4,27,"DC");
      cov_label(! tmp_4,28,"DC");
      if (tmp_4) {
        int tmp_5;
        tmp_5 = ALIM();
        ;
        cov_label(Up_Separation >= tmp_5,29,"DC");
        cov_label(! (Up_Separation >= tmp_5),30,"DC");
        if (Up_Separation >= tmp_5) tmp_6 = 1; else tmp_6 = 0;
      }
      else tmp_6 = 0;
    }
...
{
  _Bool __retres;
  cov_label(Own_Tracked_Alt < Other_Tracked_Alt,31,"DC");
  cov_label(! (Own_Tracked_Alt < Other_Tracked_Alt),32,"DC");
...
{
  _Bool __retres;
  cov_label(Other_Tracked_Alt < Own_Tracked_Alt,33,"DC");
  cov_label(! (Other_Tracked_Alt < Own_Tracked_Alt),34,"DC");
...
int alt_sep_test(void)
{
  ...
  if (enabled && (tcas_equipped && intent_not_known || ! tcas_equipped)) {
    ...
    if (tmp) {
      _Bool tmp_0;
      tmp_0 = Own_Below_Threat();
      cov_label(tmp_0,39,"DC");
      cov_label(! tmp_0,40,"DC");
      if (tmp_0) tmp_1 = 1; else tmp_1 = 0;
    }
    else tmp_1 = 0;
    need_upward_RA = (_Bool)(tmp_1 != 0);
    tmp_2 = Non_Crossing_Biased_Descend();
    cov_label(tmp_2,41,"DC");
    cov_label(! tmp_2,42,"DC");
    if (tmp_2) {
      _Bool tmp_3;
      tmp_3 = Own_Above_Threat();
      cov_label(tmp_3,43,"DC");
      cov_label(! tmp_3,44,"DC");
      if (tmp_3) tmp_4 = 1; else tmp_4 = 0;
    }
    else tmp_4 = 0;
    need_downward_RA = (_Bool)(tmp_4 != 0);
    cov_label(need_upward_RA && need_downward_RA,45,"DC");
    cov_label(! (need_upward_RA && need_downward_RA),46,"DC");
    if (need_upward_RA && need_downward_RA) alt_sep = 0;
    else {
      cov_label(need_upward_RA,47,"DC");
      cov_label(! need_upward_RA,48,"DC");
      if (need_upward_RA) alt_sep = 1;
      else {
        cov_label(need_downward_RA,49,"DC");
        cov_label(! need_downward_RA,50,"DC");
